...
const FoodDetails = () => {
  ...
  return (
    <div className="bg-gray-100 w-screen h-screen dark:bg-gray-900 p-8 max-w-full mx-auto shadow-lg">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-semibold text-blue-700 dark:text-white">
        🍽️ Food Services Dashboard
        </h2>
        <button
      ...
      {food.length === 0 ? (
        <div className="text-center text-gray-500">No Food services found.</div>
      ) : (
